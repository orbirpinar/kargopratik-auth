...
<body class="body" style="padding:0 !important; margin:0 auto !important; display:block !important; min-width:100% !important; width:100% !important; background:#F0FAFA; -webkit-text-size-adjust:none;">
    <center>
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin: 0; padding: 0; width: 100%; height: 100%;" bgcolor="#F0FAFA" class="gwfw">
            <tr>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td class="mpx-10">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td class="text-12 c-grey l-grey a-right py-20" style="font-size:12px; line-height:16px; font-family: Helvetica, sans-serif; min-width:auto !important; color:#6e6e6e; text-align:right; padding-top: 20px; padding-bottom: 20px;">
                                                        <a href="#" target="_blank" class="link c-grey" style="text-decoration:none; color:#6e6e6e;"><span class="link c-grey" style="text-decoration:none; color:#6e6e6e;">Bu e-postayı taracıyıda görüntüle</span></a>
                                                    </td>
                                                </tr>
                                            </table>
                                            <!-- END Top -->
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td class="pt-10" style="border-radius: 10px 10px 0 0; padding-top: 10px;">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td class="img-center p-30 px-15" style="font-size:0pt; line-height:0pt; text-align:center; padding: 30px; padding-left: 15px; padding-right: 15px;">
                                                                                <a href="#" target="_blank"><img src="https://kargopratik-image-bucket.s3.eu-central-1.amazonaws.com/kargopratik-logo.png" width="216" height="40" border="0" alt="" /></a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    <!-- Logo -->
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="pb-50" style="padding-bottom: 50px;">
                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="text-16 lh-20 a-center pt-25" style="font-size:14px; color:#9391A1; font-family: Helvetica, sans-serif; min-width:auto !important; line-height: 20px; text-align:center; padding-top: 25px;">
                                                                                                        Sorunuz varsa bu maili cevaplayabilirsiniz veya aşağıdaki e-posta adresinden bizimle iletişime geçebilirsiniz!
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                ...
                                                <tr>
                                                    <td class="p-50 mpx-15" bgcolor="#000000" style="border-radius: 0 0 10px 10px; padding: 30px;">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <!-- <table border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                <a href="#" target="_blank"><img src="images/twitter.png" width="16" height="16" border="0" alt="" /></a>
                                                                            </td>
                                                                            <td class="img" width="15" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
                                                                            <td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                <a href="#" target="_blank"><img src="images/facebook.png" width="16" height="16" border="0" alt="" /></a>
                                                                            </td>
                                                                            <td class="img" width="15" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
                                                                            <td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                <a href="#" target="_blank"><img src="images/google.png" width="16" height="16" border="0" alt="" /></a>
                                                                            </td>
                                                                        </tr>
                                                                    </table> -->
                                                                    <!-- END Socials -->
                                                            ...
                                                            <tr>
                                                                <td class="text-14 lh-24 a-center c-white l-white pb-20" style="font-size:14px; font-family: Helvetica, sans-serif; min-width:auto !important; line-height: 24px; text-align:center; color:#ffffff; padding-bottom: 20px;">
                                                                    Yeşilova mh. 2. Aşıkveysel cd. 
                                                                    <br /> No: 10/8 Küçükçekmece İSTANBUL
                                                                    <br />
                                                                    <br />
                                                                    <a href="mailto:info@kargopratik.com" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;">info@kargopratikcom</span></a>                                                                    - <a href="www.kargopratik.com" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;">www.kargopratik.com</span></a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td class="text-12 lh-22 a-center c-grey- l-grey py-20" style="font-size:12px; color:#6e6e6e; font-family: Helvetica, sans-serif; min-width:auto !important; line-height: 22px; text-align:center; padding-top: 20px; padding-bottom: 20px;"></td>
                                                </tr>
                                            </table>
                                            <!-- END Bottom -->
                                        </td>
